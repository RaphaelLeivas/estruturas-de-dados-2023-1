...
int main(int argc, char** argv) {
    ...
    // monta um array de Points, para esquecer a lista
    Point* points = new Point[pointsList.getSize()];

    for (int i = 0; i < pointsList.getSize(); i++) {
        points[i] = pointsList.getByIndex(i);
    }
